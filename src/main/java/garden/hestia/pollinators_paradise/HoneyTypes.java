...
public class HoneyTypes {
	public static final HoneyType CHORUS = HoneyType.register("CHORUS", new HoneyType(0xff8f31aa, 0xff8f31aa, new float[]{0.66F, 0.41F, 0.73F}, PollinatorsItems.CHORUS_HONEY_BOTTLE));
